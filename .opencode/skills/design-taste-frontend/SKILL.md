...
description: Anti-slop frontend design skill. Use when building, styling, or redesigning frontend UI for this app — pages, dashboards, components, or full layouts — to avoid templated or AI-default aesthetics. Reads the brief, infers a design direction (design read + DESIGN_VARIANCE / MOTION_INTENSITY / VISUAL_DENSITY dials), picks real design systems, and enforces typography, color, layout, accessibility and motion guardrails. Not for backend, data, or infrastructure work.
---
