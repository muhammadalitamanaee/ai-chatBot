    ...
    <div className="border-t border-neutral-200 bg-white px-4 py-4">
      <div className="max-w-3xl mx-auto flex gap-3 items-end">
        <textarea
          ...
          rows={1}
          disabled={isLoading}
          className="flex-1 resize-none rounded-xl border border-neutral-300 px-4 py-3 text-sm outline-none focus:border-neutral-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
